// d2vr_xrsim32 - a simulated 32-bit OpenXR runtime for agent-driven testing.
//
// This is NOT part of the mod. It links nothing from darkness2vr and ships in no
...
// xrsim.log exactly the way it follows darkness2vr.log.
namespace log {
void init();
const wchar_t* dir();          // %LOCALAPPDATA%\Darkness2VR\xrsim, or $D2VR_XRSIM_DIR
